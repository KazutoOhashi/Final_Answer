...
# データベースに接続
database_url = 'mysql+pymysql://root:mysql@127.0.0.1:3306/ex2?charset=utf8mb4'
engine = create_engine(database_url)

# データフレームをMySQLのテーブルに変換
df.to_sql(name = 'ex2_2', con = engine, if_exists = 'replace', index = False)
print('MySQL table has been saved successfully.')